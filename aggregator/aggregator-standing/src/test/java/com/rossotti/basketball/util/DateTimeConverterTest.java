...
public class DateTimeConverterTest {
    ...
    public void getLocalDateTime_FromZonedDateTime() {
        ...
        assertEquals(LocalDateTime.of(2015, 11, 29, 18, 0), dateTime);
    }
    ...
    public void getLocalDateSeasonMin_SeasonStart() {
        ...
        assertEquals(LocalDate.of(2013, 7, 1), date);
    }
    @Test
    ...
    public void getLocalDateSeasonMax_SeasonStart() {
        ...
        assertEquals(LocalDate.of(2015, 6, 30), date);
    }
    @Test
    ...
    public void getLocalDateTimeSeasonMin_SeasonStart() {
        ...
        assertEquals(LocalDateTime.of(2013, 7, 1, 0, 0), dateTime);
    }
    @Test
    ...
    public void getLocalDateTimeSeasonMax_SeasonStart() {
        ...
        assertEquals(LocalDateTime.of(2015, 6, 30, 23, 59), dateTime);
    }
    @Test
    ...
    public void createDateMinusOneDay_EndOfMonth() {
        ...
        assertEquals(LocalDate.of(2013, 6, 29), date);
    }
    @Test
    public void createDateMinusOneDay_BeginningOfMonth() {
        ...
        assertEquals(LocalDate.of(2013, 6, 30), date);
    }

    @Test
    public void isDate_PastDate() {
        assertTrue(DateTimeConverter.isDate("1969-12-31"));
    }
    @Test
    public void isDate_FutureDate() {
        assertTrue(DateTimeConverter.isDate("2069-12-31"));
    }
    @Test
    public void isDate_InvalidDate() {
        assertFalse(DateTimeConverter.isDate("2069-12"));
    }
}