...
public class Standing {
    ...
    private Short lastFive;
    private Short lastTen;
    ...
    public Short getLastFive() {
        return lastFive;
    }
    public void setLastFive(Short lastFive) {
        this.lastFive = lastFive;
    }

    public Short getLastTen() {
        return lastTen;
    }
    public void setLastTen(Short lastTen) {
